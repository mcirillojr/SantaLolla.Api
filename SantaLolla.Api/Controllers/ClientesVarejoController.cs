...
namespace SantaLolla.Api.Controllers
{
    ...
    public class ClientesVarejoController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Permite filtros por rede, código do cliente, CPF/CNPJ, nome e data de atualização.
        /// 
        ...
        /// </remarks>
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<ClienteVarejoResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        public async Task<ActionResult<IEnumerable<ClienteVarejoResponse>>> Listar(
            [FromQuery] ClienteVarejoFiltroRequest filtro
        )
        {
            var clientes = await _clienteVarejoRepository.ListarAsync(filtro);
